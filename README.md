...
Test Automation with Pipeline - Azure DevOps - Terraform - JMeter -Selenium - Postman
...
```sh
git clone https://github.com/thoanvo/devops-training-project03.git
```
...
* Execute the script **commands.sh** :
...
> access_key: s5TZcSCI8SmN4Zs6vqCIPATMtbZlk/Hm6h4oGjwph3Iy0EKcj1XgOwXjyTD5ZEwYdUTP3DVDYG06+AStIppV6g==
